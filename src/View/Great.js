...
const Great = () => {
  ...
  const total = workouts[exc[0]] * WORKOUTS_SET_AND_REPS[exc[0]][0] * WORKOUTS_SET_AND_REPS[exc[0]][1] +
      workouts[exc[1]]  * WORKOUTS_SET_AND_REPS[exc[1]][0] * WORKOUTS_SET_AND_REPS[exc[1]][1] +
      workouts[exc[2]]  * WORKOUTS_SET_AND_REPS[exc[2]][0] * WORKOUTS_SET_AND_REPS[exc[2]][1]
